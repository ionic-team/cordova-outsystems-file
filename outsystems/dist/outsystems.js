(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.OSFilePluginWrapper = {}));
  ...
  class LegacyCordovaBridge {
    ...
    readFile(success, error, path, name, isInternal, isTemporary) {
      let directory = this.getDirectoryTypeFrom(isInternal, isTemporary);
      let options = {
        path: `${path}/${name}`,
        directory
  ...
  exports2.LegacyMigration = LegacyMigration;
