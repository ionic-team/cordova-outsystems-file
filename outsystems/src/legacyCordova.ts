...
class LegacyCordovaBridge {
    ...
    writeFile(success: (res: WriteFileResult) => void, error: (err: PluginError) => void, isInternal: boolean, isTemporary: boolean, data: string | Blob, path: string): void {
    ...
    readFile(success: (res: ReadFileResult) => void, error: (err: PluginError) => void, isInternal: boolean, isTemporary: boolean, path: string): void {
