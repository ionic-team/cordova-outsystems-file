...
| **`offset`**    | <code>number</code>                             | The offset to start reading the file from, in bytes. Can be used in conjunction with length to partially read files.                                                        | <code>0</code>  | 1.1.0 |
| **`length`**    | <code>number</code>                             | The length of data to read, in bytes. Any non-positive value means to read to the end of the file. Can be used in conjunction with offset to partially read files.          | <code>-1</code> | 1.1.0 |
